"""# SEIR-HCD Model
This is a working example of a [SIER](https://en.wikipedia.org/wiki/Compartmental_models_in_epidemiology#The_SEIR_model) model with added compartments for HCD. The letters stand for Susceptible, Exposed, Infected, Recovered, Hospitalized, Critical, Death
